...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty()) || (txtUsuLogin.getText().isEmpty()) || (txtUsuSenha.getText().isEmpty())) {
                ...
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Usuário adicionado no sistema com sucesso!");
                    // as linhas abaixo "limpam" os campos
    ...
    private void alterar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty()) || (txtUsuLogin.getText().isEmpty()) || (txtUsuSenha.getText().isEmpty())) {
                ...
                // System.out.println(adicionado);
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Dados do usuário alterados no sistema com sucesso!");
                    // as linhas abaixo "limpam" os campos
                    txtUsuId.setText(null);
                    txtUsuNome.setText(null);
                    txtUsuFone.setText(null);
    ...
    private void remover() {
        ...
        if ((txtUsuId.getText().isEmpty())) {
            JOptionPane.showMessageDialog(null, "Preencha o campo ID Obrigatório!");
        } else {
            // a estrutura abaixo confirma a remoção do usuário
            int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja removar este usuário?!", "Atenção", JOptionPane.YES_NO_OPTION);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtUsuLogin, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
